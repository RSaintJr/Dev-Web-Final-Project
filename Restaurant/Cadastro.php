...
<form action="?page=salvar" method="POST">
    ...
    <div >
            <p>Informação do Cartão de Crédito</p>
                ...
                <input type="number" name="cartaoN" id="cartaoN" placeholder="0000 0000 0000 0000" required>
                <br>
                <br>
                <label>Validade do Cartão</label>
                <input type="date" name="cartaoV" id="cartaoV" required>
                <br>
                <br>
                <label>Código de Segurança</label>
                <input type="number" name="cartaoS" id="cartaoS" required placeholder="CVC">
                <br>
                <br>
        </div>
    <div class="mb-3">
